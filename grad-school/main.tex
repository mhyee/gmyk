...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      \draw (0,0.7) ellipse (2cm and 1cm) node[align=center]
        {\textbf{\footnotesize Most applicable}\\
        {\footnotesize computer science,}\\
        {\footnotesize software engineering}};
      \draw (0,0) ellipse (3.5cm and 2cm) node[below=0.5cm, align=center]
...
{%
  ...
  \item I'm a 4B Software Engineering student (undergrad, class of 2014)
...
{%
  ...
  \item Sometimes a US master's is earned en-route to a PhD
}
...
{%
  ...
  \item Some companies may not care about graduate degrees, depending on the
        position
